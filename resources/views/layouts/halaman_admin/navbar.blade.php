            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-bs-toggle="dropdown">
                    ...
                    @elseif ($admin->gender == 'W')
                        <img class="img-xs rounded-circle" src="{{ asset('template') }}/images/faces/face2.jpg" alt="Profile image" style="width: 40px; height: 40px;">
                    @endif
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('admin.ubah_pwd') }}">
