                        ...
                        <div class="col-lg-12 d-flex flex-column">
                            <div class="row flex-grow">
                                <div class="col-lg-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title text-center">Edit Departemen</h4>
                                            <p class="card-description text-center">
                                                Digunakan pada saat proses rekrutmen
                                            </p>
                                            <form action="{{ route('admin.departemen.update_departemen', $departemen->id) }}"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text"
                                                        ...
                                                        name="departemen" value="{{ old('departemen', $departemen->departemen) }}">
                                                ...
                                                <div class="form-floating">
                                                    <input type="text"
                                                        ...
                                                        id="floatingPassword" placeholder="Masukkan PiC" name="pic" value="{{ old('pic', $departemen->PIC) }}">
